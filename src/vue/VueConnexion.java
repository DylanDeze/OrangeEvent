...
public class VueConnexion extends JFrame implements ActionListener, KeyListener{
	...
	// Technicien connecter en static 
	private static Technicien unTechnicienConnecte = null;
	
	public static Technicien getTechnicien ()
	{
		return unTechnicienConnecte;
	}
	...
	public void traitement () 
	{
		...
		unTechnicienConnecte = C_Technicien.selectWhereTechnicien(email, mdp);
		if (unTechnicienConnecte == null)
		{
			JOptionPane.showMessageDialog(this, "Veuillez vérifier vos identifiants");
		} else {
			JOptionPane.showMessageDialog(this, "Bienvenue "+unTechnicienConnecte.getNom() + " " + unTechnicienConnecte.getPrenom());
